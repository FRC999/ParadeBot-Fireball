...
public class BreacherArmLeftRetract extends Command {
  /** Creates a new BreacherArmLeftRetract. */
  public BreacherArmLeftRetract() {
  ...
  public void end(boolean interrupted) {
    RobotContainer.breacherMotorLeftSubsystem.stopLeftBreacherArm();
  }
